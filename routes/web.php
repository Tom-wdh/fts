...
Route::get('/festival/create', [FestivalController::class, 'create'])->name('festival.create')->Middleware('admin');
...
Route::get('/trip/{festival}/create', [TripController::class, 'create'])->name('trip.create')->Middleware('admin');
