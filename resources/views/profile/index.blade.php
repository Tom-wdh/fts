<x-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 w-96">
            <h2 class="text-xl font-semibold mb-4">Gebruikers Informatie <a href="{{ route('profile.edit') }}"
                    class="text-xs font-normal text-cyan-400">bewerken</a></h2>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <ul class="flex flex-wrap justify-start align-center">
            @if ($trips->isEmpty())
                <p class="text-gray-500">Je hebt nog geen trips geboekt.</p>
            @else
